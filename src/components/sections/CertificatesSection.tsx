      ...
      <div className="aspect-[16/10] relative overflow-hidden flex items-center justify-center flex-shrink-0">
        ...
        {isEditable && (
            <button 
              ...
              className="absolute top-3 right-3 w-7 h-7 bg-black text-[#d90429] border border-[#d90429] flex items-center justify-center hover:bg-[#d90429] hover:text-white transition-all shadow-[0_0_10px_rgba(217,4,41,0.3)] z-[100]"
            >
